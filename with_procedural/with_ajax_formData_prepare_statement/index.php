<?php
    ...
    // Logic to fetch records from database with using prepare statement concept
    ...
    if(isset($_POST["delete_id"])){
        ...
        $delete_result = mysqli_prepare($conn, "DELETE FROM signup_form_data WHERE id = ?");
        mysqli_stmt_bind_param($delete_result, 'i', $_POST["delete_id"]);
                        ...
                        foreach($result_arr as $records){
                            echo"
                                <tr>
                                    ...
                                    <td><img src='{$records['profile_pic']}' width='80px' height='60px' /></td>
                                    <td>
