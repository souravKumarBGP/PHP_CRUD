                ...
                $("#signup_form").on("submit", function(event){
                    ...
                    if(inputs_feilds.length == greet){
                        ...
                        $.ajax({
                            ...
                            type:"post",
                            data: {"user_name": user_name, "phone_number": phone_number, "email_id": email_id, "new_password": new_password, "gender": gender},
                            success: function(responce){
                                ...
                                if(responce == "invlide_phone_no"){
                                    alert("Enter valid mobile number !");
                                }
                                if(responce == "email_exist"){
                                    alert("Email is already exist !");
                                }
                                if(responce == "max_length"){
                                    alert("Max-length allowed only 199 cherectors");
                                }
                                if(responce == "feild_empti"){
