        ...
        foreach($reset_form_data_array as $key => $value){
            ...
            if($value != ""){
                ...
                if(strlen($value) < 200){
                    ...
                    $select_querry = "SELECT email_id, new_password FROM signup_form_data WHERE email_id = '{$reset_form_data_array["email_id"]}'";
                    ...
                    if(mysqli_num_rows($result) == 1){
                        ...
                        if($reset_form_data_array["new_password"] == $reset_form_data_array["confirm_password"]){
                            ...
                            $update_querry = "UPDATE signup_form_data SET new_password = '{$pass}' WHERE email_id = '{$reset_form_data_array["email_id"]}'";
