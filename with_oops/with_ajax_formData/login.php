                    ...
                    <form action="<?php echo $_SERVER["PHP_SELF"]?>" method="post" id="login_form" autocomplete="off">
                        ...
                        <div class="inputBox my-2">
                            ...
                            <div class="input_group">
                                ...
                                <input type="password" name="new_password" id="new_password" autocomplete="on" />
                            </div><!--***End of input_group-->
                    ...
                    if(inputs_feilds.length == greet){
                        ...
                        $.ajax({
                            ...
                            success: function(responce){
                                ...
                                if(responce.trim() == "email_not_registred"){
                                ...
                                if(responce.trim() == "password_not_match"){
                                    $(".error_message").css({"display":"block"});
                                    $(".success_message").css({"display":"none"});
                                    $(".error_message").html("Password is not matched <a href='./reset_password.php' style='color:yellow !important;'> Reset Password </a> !");
                                }
                                if(responce.trim() == "maxLength_error"){
                                    $(".error_message").css({"display":"block"});
                                    $(".success_message").css({"display":"none"});
                                    $(".error_message").html("Maximul length of cherectors 199 !");
                                }
                                if(responce.trim() == "input_blank"){
                                    $(".error_message").css({"display":"block"});
                                    $(".success_message").css({"display":"none"});
                                    $(".error_message").html("Fill the all input box!");
                                }
                            }
